...
(lon >= 43.13, the same split boundary used in main_local_mosul_retrain.py)
...
Usage:
    python3 alex/tmp/create_mosul_east_bank_labels.py
"""
...
def main():
    ...
    print(
        ...
        "resolve to the retrained probability rasters, not the zero-shot ones. Since "
        "city_id here is 'MOS_RETRAINED_EAST_ONLY' but the retrained rasters were saved "
